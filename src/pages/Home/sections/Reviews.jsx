      ...
      <div className="container">
        <div className="flex items-center md:flex-row flex-col justify-between md:gap-20 gap-6 w-full">
          <div className="max-w-[662px]">
            ...
            Отзывы о нас и мы в цифрах!
            </h1>
            <p className="text-secondary md:leading-[30px] leading-[21px] md:text-[20px] text-[14px]">
            За годы нашей работы мы выросли в современный центр, внедрили несколько уникальных методик и курсов оздоровления, и действительно помогли обрести здоровье большому количеству людей-от самых маленьких-до пожилых людей глубокого возраста.
            </p>
          </div>
